...
abstract class SimpleOrm
{
    ...
    {
        $count = self::sql($sql, self::FETCH_ONE);
    ...
    {
        self::sql('TRUNCATE :database.:table', self::FETCH_NONE);
    }
    ...
    public static function retrieveByPK ($pk)
    {
        ...
        return $reflectionObj->newInstanceArgs(array($pk, self::LOAD_BY_PK));
    }
    ...
    public static function hydrate ($data)
    {
        ...
        return $reflectionObj->newInstanceArgs(array($data, self::LOAD_BY_ARRAY));
    }
